...
#ifndef SPPOLYGONPLOTTER_H
#define SPPOLYGONPLOTTER_H
...
class SPPolygonPlotter : public SPAbstractPlooter
{
    Q_OBJECT
public:
    explicit SPPolygonPlotter(QObject *parent = 0);

    void clear();
    void setData(QList<QPair<QList<QPointF>,QColor>> data);
    void setData(QPolygonF data,QColor color);
